...
async function getmain(x1) {
  postUrl="https://graphql.haraj.com.sa/?queryName=initialPosts&token=&clientId=e7HCGEr1-Kmd0-Izny-HqGC-Z7i1VMVQHAqMv3&version=8.2.1%20,%203%2026%20-%209%20-%2022/"
  postHeader={
    "headers": {
      "content-type": "text/plain; charset=utf-8",
      ...
      "sec-ch-ua-mobile": "?0",
      "sec-ch-ua-platform": "\"Windows\"",
      "trackid": "eyJ0YWciOiLYp9iz2KrYsdin2K3Yp9iqINmE2YTYp9mK2KzYp9ixIiwiY2l0eSI6Itis2K/ZhyJ9"
    },
    "referrer": "https://haraj.com.sa/",
    "referrerPolicy": "strict-origin-when-cross-origin",
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36",
    "body": `{\"query\":\"query($tag:String,$city:String,$page:Int) { posts( tag:$tag, city:$city, page:$page) {\\n\\t\\titems {\\n\\t\\t\\tid status authorUsername title city postDate updateDate hasImage thumbURL authorId\\n\\t\\t}\\n\\t\\tpageInfo {\\n\\t\\t\\thasNextPage\\n\\t\\t}\\n\\t\\t} }\",\"variables\":{\"tag\":\"استراحات للايجار\",\"city\":\"جده\",\"page\":${x1}}}`,
    "method": "POST",
    "mode": "cors",
    "credentials": "omit"
  }
